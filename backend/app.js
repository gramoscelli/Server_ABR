...
var accountingAuditRouter = require('./routes/accounting/audit');
...
app.use('/api/accounting/audit', authenticateToken, authenticatedAwareApiLimiter, accountingAuditRouter); // Audit is read-only, no CSRF needed
